...
public sealed class Snappy : IDalamudPlugin
{
    ...
    public Snappy(IDalamudPluginInterface pluginInterface)
    {
        ...
        ConfigWindow = new ConfigWindow(this, Configuration, ActiveSnapshotManager);
        MainWindow = new MainWindow(this, ActorService, ActiveSnapshotManager, McdfManager, PmpManager,
